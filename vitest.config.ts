...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@vybz/processing/mastering", replacement: path.resolve(__dirname, "./packages/processing/mastering/src/index.ts") },
      { find: "@vybz/processing/metadata", replacement: path.resolve(__dirname, "./packages/processing/metadata/src/index.ts") },
