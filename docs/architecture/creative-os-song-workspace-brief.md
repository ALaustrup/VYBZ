...
> **SUPERSEDED 2026-08-21.** Authority is [`PRODUCT.md`](../../PRODUCT.md) Version 9 and decision [`0011`](../decisions/0011-living-profile.md). Music is a specialization of Creative Work, not the unit. This brief remains as history. Do not implement from it.
