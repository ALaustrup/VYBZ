...
| Module | Role |
|--------|------|
| **Home** | Signed-in people landing at `/` — live, people, rooms, work |
| **My VYBZ / Stage File** | Owner dashboard and public `/u/:id` — same living profile |
| **Library** | Authorized works at `/library` — hidden from default chrome |
| **Workspace** | Archived at `/workspace` — not a second home |
