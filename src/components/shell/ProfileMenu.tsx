...
const PRIMARY: NavItem[] = [
  ...
  },
  {
    id: "listen",
    label: "Listen",
    to: "/workspace?tab=listen",
    icon: Headphones,
    match: (p, tab) => p === "/workspace" && tab === "listen",
  },
  {
    id: "live",
    label: "Live",
    to: "/live",
    icon: Radio,
    match: (p, tab) => (p === "/workspace" && tab === "live") || p.startsWith("/live"),
  },
  {
    id: "connect",
    label: "Connect",
    to: "/connect",
    icon: Heart,
    match: (p, tab) => p === "/workspace" && tab === "connect",
  },
  {
    id: "you",
    label: "You",
    to: "/workspace?tab=you",
    icon: Users,
    match: (p, tab) => p === "/workspace" && tab === "you",
  },
  {
    id: "wallet",
    label: "Wallet",
    to: "/workspace?tab=wallet",
    icon: Wallet,
    match: (p, tab) => p === "/workspace" && tab === "wallet",
  },
];
