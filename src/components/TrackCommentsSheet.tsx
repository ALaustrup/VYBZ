      ...
      {open && dropId && (
        <OverlayPortal>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 z-[91] mx-auto flex w-full max-w-lg flex-col rounded-t-3xl border-t border-white/12 bg-ink-900/96 shadow-card backdrop-blur-2xl"
            style={{
              bottom: "calc(var(--dock-reserve, 6.25rem) + 0.35rem)",
              maxHeight: "min(78dvh, calc(100dvh - var(--dock-reserve, 6.25rem) - 1.5rem))",
            }}
          >
            ...
            <div className="no-scrollbar min-h-0 flex-1 overflow-y-auto px-4 py-3 pb-4">
