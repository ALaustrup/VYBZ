  ...
  return (
    <div className="space-y-4">
      ...
      <p className="rounded-2xl border border-aqua-400/20 bg-aqua-400/[0.05] px-4 py-3 text-[13px] leading-relaxed text-white/70">
        Every action earns <span className="font-semibold text-aqua-200">credits</span> — spendable on <a href="/store" className="font-semibold text-aqua-100 underline-offset-2 hover:underline">Flair</a> (Profile Enhancement — looks only, never match rank). Thank you for keeping VYBZ real.
      </p>
