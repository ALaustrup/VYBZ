...
const LABELS: SurfaceRule[] = [
  ...
  { test: (p) => p.startsWith("/release/") && p.includes("/distribution"), id: "relay", label: "Delivery", product: "relay", mode: "professional" },
  { test: (p) => p.startsWith("/tools/packs") || p.startsWith("/pack/"), id: "market", label: "Shop", product: "market", mode: "professional" },
  { test: (p) => p.startsWith("/credits"), id: "credits", label: "Credits", product: "credits", mode: "professional" },
  { test: (p) => p.startsWith("/release/") && p.includes("/master"), id: "master", label: "Master", product: "master", mode: "professional" },
  { test: (p) => p.startsWith("/master"), id: "master", label: "Master", product: "master", mode: "professional" },
  { test: (p) => p.startsWith("/release/") && p.includes("/artwork"), id: "coverlab", label: "Cover", product: "coverlab", mode: "professional" },
  { test: (p) => p.startsWith("/coverlab") || p.startsWith("/visuals"), id: "coverlab", label: "Cover", product: "coverlab", mode: "professional" },
  ...
  { test: (p) => p.startsWith("/release/"), id: "prepare", label: "Scan", product: "prepare", mode: "professional" },
  { test: (p) => p.startsWith("/messages") || p.startsWith("/rooms"), id: "messages", label: "Messages", mode: "audience" },
  { test: (p) => p.startsWith("/market"), id: "market", label: "Shop", product: "market", mode: "professional" },
