...
export const CODEX_DOCS: CodexDoc[] = [
  ...
  { slug: "terms", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Terms of Service", summary: "Music Hub (SoundCloud × Spotify × Twitch), Vc tips, optional Connection Lab — binding terms.", jurisdiction: "Astra Matrix, Inc.", version: "2.0", path: "/legal/terms.md" },
  { slug: "privacy", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Privacy Policy", summary: "What we collect for streaming, live, Vc, and optional Connection Lab — and your rights.", jurisdiction: "Astra Matrix, Inc.", version: "3.0", path: "/legal/privacy.md" },
  ...
  { slug: "acceptable-use", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Acceptable Use Policy", summary: "Conduct rules for music, live, and Connection Lab (18+ adult intents).", jurisdiction: "Astra Matrix, Inc.", version: "2.0", path: "/legal/acceptable-use.md" },
  { slug: "vc", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "VYBZ Credits (Vc) Whitepaper", summary: "Closed-loop social currency: $0.05 peg, ledger, P2P, earn model, and 2027 VYBZ token roadmap.", jurisdiction: "Astra Matrix, Inc.", version: "1.1", path: "/legal/vc.md" },
];
