...
export const CODEX_DOCS: CodexDoc[] = [
  ...
  { slug: "terms", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Terms of Service", summary: "Tip + live + catalog Music Hub for indie artists; Vc tips; optional Connection Lab; alpha waitlist.", jurisdiction: "Astra Matrix, Inc.", version: "3.0", path: "/legal/terms.md" },
  { slug: "privacy", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Privacy Policy", summary: "Data for streaming, live, Vc tips, alpha waitlist email, and optional Connection Lab — and your rights.", jurisdiction: "Astra Matrix, Inc.", version: "4.0", path: "/legal/privacy.md" },
  ...
  { slug: "acceptable-use", kind: "policy", category: "Platform Legal · Astra Matrix, Inc.", title: "Acceptable Use Policy", summary: "Conduct for music, tips, live, and opt-in Connection Lab (18+ adult intents).", jurisdiction: "Astra Matrix, Inc.", version: "3.0", path: "/legal/acceptable-use.md" },
