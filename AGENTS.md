...
**Active wedge: OR-037 Converter formats** (WAV16/WAV24/Opus-WebM; honest matrix). Prefer small
reviewable PRs on `feat/or-037-*` / `feat/creative-os-*`. Gates:
`or036MidiMakerGate.test.ts`, `or037ConverterFormatsGate.test.ts`.
...
1. **Creative OS / OR-037** (active) — Converter format matrix (WAV 16/24 + Opus/WebM when
   supported; MP3/AAC/FLAC encode disclosed unavailable). OR-032–OR-036 shipped.
2. **Follow-on Creative OS wedges** (authorised sequence, separate PRs) — see
   `IDEAS_BACKLOG.md` §8.4 / §8.5: OR-038 Pack Maker←Library→Store,
...
**OR-034 shipped** (PR #154). **OR-035 shipped** (PR #155). **OR-036 shipped** (PR #156). **Active:** **OR-037** Converter formats.
